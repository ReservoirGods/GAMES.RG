...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Random_GameInit( void )
* ACTION   : called at start of game
* CREATION : 26.01.01 PNK
*-----------------------------------------------------------------------------------*/

void			Random_GameInit( void )
{
}


/*-----------------------------------------------------------------------------------*
* FUNCTION : Random_LevelInit( void )
* ACTION   : called start of level
* CREATION : 26.01.01 PNK
*-----------------------------------------------------------------------------------*/

void			Random_LevelInit( void )
{
}
...
/*-----------------------------------------------------------------------------------*
* FUNCTION : Random_GetNumber( U16 aMax )
* ACTION   : returns random number between 0..aMax
* CREATION : 13.01.01 PNK
*-----------------------------------------------------------------------------------*/

U16	Random_GetNumber( U16 aMax )
{
	uU32	lNum;
